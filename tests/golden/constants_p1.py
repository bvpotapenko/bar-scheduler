...
P1_INCLINE_15W_SESSIONS = [
    ...
    },
    {
        ...
        "bodyweight_kg": 50.0,
        "sets": [
            {"reps": 12, "rest_seconds": 45, "added_weight_kg": 4.0, "rir_reported": 0},
...
P1_INCLINE_FUTURE_SESSIONS = [
    {
        "date": "2026-01-13",
        "type": "TEST",
        "prescribed_sets": [{"reps": 10, "weight_kg": 8.5, "rest_s": 240}],
    },
    {
        "date": "2026-01-16",
        "type": "H",
        "prescribed_sets": [
            {"reps": 7, "weight_kg": 7.0, "rest_s": 120},
    ...
    },
    {
        ...
        "type": "S",
        "prescribed_sets": [
            {"reps": 4, "weight_kg": 7.0, "rest_s": 240},
...
P1_BSS_FUTURE_SESSIONS = [
    {
        "date": "2026-01-13",
        "type": "TEST",
        "prescribed_sets": [{"reps": 6, "weight_kg": 12.0, "rest_s": 240}],
    },
    {
        "date": "2026-01-15",
        "type": "S",
    ...
    },
    {
        ...
        "type": "H",
        "prescribed_sets": [
            {"reps": 9, "weight_kg": 12.0, "rest_s": 120},
...
P1_DIP_DONE_METRICS = [
    {"volume_session": 78.0, "avg_volume_set": 78.0, "estimated_1rm": 27.7},
...
P1_INCLINE_DONE_METRICS = [
    {"volume_session": 32.0, "avg_volume_set": 32.0, "estimated_1rm": 5.01},
...
P1_BSS_DONE_METRICS = [
    {"volume_session": 237.5, "avg_volume_set": 237.5, "estimated_1rm": 53.73},
    ...
    "future_sessions": [
        {
            ...
            "type": "S",
            "prescribed_sets": [
                {"reps": 5, "weight_kg": 7.0, "rest_s": 240},
                {"reps": 4, "weight_kg": 7.0, "rest_s": 240},
                {"reps": 4, "weight_kg": 7.0, "rest_s": 240},
            ],
        },
        {
            ...
            "type": "H",
            "prescribed_sets": [
                {"reps": 8, "weight_kg": 7.0, "rest_s": 120},
                {"reps": 7, "weight_kg": 7.0, "rest_s": 120},
                {"reps": 6, "weight_kg": 7.0, "rest_s": 120},
                {"reps": 5, "weight_kg": 7.0, "rest_s": 120},
            ],
...
P1_BSS_AFTER_IMPROVED_TEST = {
    ...
    "future_sessions": [
        ...
        },
        {
            ...
            "type": "S",
            "prescribed_sets": [
                {"reps": 5, "weight_kg": 14.0, "rest_s": 195},
        ...
        },
        {
            ...
            "type": "H",
            "prescribed_sets": [
                {"reps": 9, "weight_kg": 14.0, "rest_s": 120},
